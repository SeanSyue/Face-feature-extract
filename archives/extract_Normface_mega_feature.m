...
%% caffe setttings
matCaffe = fullfile(pwd, '../Face-caffe-test2/matlab');
...
model   = 'models/Normface_model/face_deploy.prototxt';
weights = 'models/Normface_model/Center Face 99.2/face_train_test_iter_6000.caffemodel';
net     = caffe.Net(model, weights, 'test');

storage_dir = '/home/ee303/SEAN/Face-feature-extract/feature_output_mega_mat/Normface';
